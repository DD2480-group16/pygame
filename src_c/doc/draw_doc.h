...
#define DOC_PYGAMEDRAWROUNDEDPOLYGON "polygon_rounded(surface, color, points, radius, smoothing) -> Rect\npolygon_rounded(surface, color, points, width=0, radius, smoothing) -> Rect\ndraw a polygon"
